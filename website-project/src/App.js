...
const Header = tw.h1`text-blue-500 text-5xl text-center font-bold pt-32 w-full xl:w-1/2 pb-9 mx-auto md:mx-0 pr-0 md:pr-8`;
...
const ResumeHeader = tw.div`flex flex-row text-lg font-bold text-red-500 mt-8 mb-4 justify-center`;
const Row = tw.div`flex flex-row mt-4 mx-4 mr-16 justify-start`;
const Description = tw.div`flex flex-col ml-8 mr-auto w-1/2`;
const Company = tw.h2`text-green-500 text-base font-semibold`;
...
const ResumeButton = tw.button`text-white flex justify-center bg-gray-800 bg-opacity-50 font-bold text-sm mx-auto my-4 py-4 align-baseline border border-gray-500 rounded-2xl h-3/5 w-10/12 hover:bg-white hover:text-black hover:border-black transition ease-in-out duration-300`;
...
const Introduction = tw.p`text-base text-gray-300 w-full h-full mb-8 mr-8`;
